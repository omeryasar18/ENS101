...
% Last Modified by GUIDE v2.5 02-Jan-2024 15:58:52
...
axes(handles.axes2)
imshow('C:\Users\Excalibur\Downloads\iusENlogo.jpg');
...
if filename ==0
    msgbox(sprintf('Please select a picture.'));
end
axes(handles.axes1)
...
% --- Executes on button press in blckwht.
function blckwht_Callback(hObject, eventdata, handles)
% hObject    handle to blckwht (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global image
axes (handles.axes1)
...
if filename==0
    msgbox(sprintf('Please select a music.'));
end
